...
//Page is a data structure of files being saved
type Page struct {
	Title       string
	Body        []byte
...
func viewHandler(w http.ResponseWriter, r *http.Request, title string) {
	...
	p.DisplayBody = template.HTML(search.ReplaceAllFunc(escapedBody, func(s []byte) []byte {
		m := search.FindStringSubmatch(string(s))
